...
#include "AnotherGame/MyPawn.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeMyPawn() {}
// Cross Module References
	ANOTHERGAME_API UClass* Z_Construct_UClass_AMyPawn_NoRegister();
	ANOTHERGAME_API UClass* Z_Construct_UClass_AMyPawn();
...
// End Cross Module References
	...
	template<> ANOTHERGAME_API UClass* StaticClass<AMyPawn>()
	{
		return AMyPawn::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AMyPawn);
	struct Z_CompiledInDeferFile_FID_AnotherGame_Source_AnotherGame_MyPawn_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_AnotherGame_Source_AnotherGame_MyPawn_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AMyPawn, AMyPawn::StaticClass, TEXT("AMyPawn"), &Z_Registration_Info_UClass_AMyPawn, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMyPawn), 2287627282U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_AnotherGame_Source_AnotherGame_MyPawn_h_1947570855(TEXT("/Script/AnotherGame"),
		Z_CompiledInDeferFile_FID_AnotherGame_Source_AnotherGame_MyPawn_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_AnotherGame_Source_AnotherGame_MyPawn_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
